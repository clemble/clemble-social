...
public abstract class Profile implements Serializable, Mutable<Profile> {
    ...
    abstract public Collection<? extends com.socialone.data.social.SocialPersonProfile> getSocialProfiles();
    ...
    public static abstract class ProfileBuilder extends Profile implements Builder<Profile> {
        ...
        final public ProfileBuilder setSocialProfiles(Collection<? extends com.socialone.data.social.SocialPersonProfile> additional) {
        ...
        public ProfileBuilder safeMerge(Profile other) {
            if (other != null) {
                ...
                if (other.getSocialProfiles() != null && !other.getSocialProfiles().isEmpty()) {
                    for (com.socialone.data.social.SocialPersonProfile otherSocialProfiles : other.getSocialProfiles())
    ...
    final public static class ImmutableProfile extends Profile implements Immutable {
        ...
        final private Collection<? extends com.socialone.data.social.SocialPersonProfile> socialProfiles;
        ...
        public ImmutableProfile(Profile other) {
            this((other != null ? other.getProfileId() : null), (other != null ? other.getSocialProfiles() : ImmutableList
                    .<com.socialone.data.social.SocialPersonProfile> of()));
        }

        public ImmutableProfile(String profileId, Collection<? extends com.socialone.data.social.SocialPersonProfile> socialProfiles) {
        ...
        @Override
        public Collection<? extends com.socialone.data.social.SocialPersonProfile> getSocialProfiles() {
    ...
    public static class SimpleProfileBuilder extends ProfileBuilder {
        ...
        public SimpleProfileBuilder(String profileId, Collection<? extends com.socialone.data.social.SocialPersonProfile> socialProfiles) {
            this.profileId = profileId;
