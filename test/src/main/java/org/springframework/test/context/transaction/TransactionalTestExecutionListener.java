...
public class TransactionalTestExecutionListener extends AbstractTestExecutionListener {
    ...
    private final Map<Method, TransactionContext> transactionContextCache = new ThreadLocalMap<Method, TransactionContext>(new ValueFactory<Map<Method,TransactionContext>>() {
        @Override
        public Map<Method, TransactionContext> create() {
            return new IdentityHashMap<Method, TransactionalTestExecutionListener.TransactionContext>();
        }
    });
