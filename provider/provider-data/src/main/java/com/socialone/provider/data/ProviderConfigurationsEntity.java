...
import com.socialone.provider.data.autodiscovery.AutodiscoveryConfiguration;
import com.socialone.provider.data.autodiscovery.AutodiscoveryConfigurationEntity;
import com.socialone.provider.data.callback.CallbackConfiguration;
import com.socialone.provider.data.callback.CallbackConfigurationEntity;
import com.socialone.provider.data.merge.MergeConfiguration;
import com.socialone.provider.data.merge.MergeConfigurationsEntity;
import com.socialone.provider.data.signin.SignInConfiguration;
import com.socialone.provider.data.signin.SignInConfigurationEntity;
