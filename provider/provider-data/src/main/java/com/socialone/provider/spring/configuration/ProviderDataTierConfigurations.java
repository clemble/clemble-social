...
import com.socialone.provider.service.jpa.JpaProviderConfigurationRepository;
...
public class ProviderDataTierConfigurations {
    ...
    static class JPAConfigurations {
        ...
        public EntityManagerFactory providerEntityManagerFactory() {
            ...
            entityManagerFactory.setPackagesToScan(new String[] { "com.socialone.provider.data" });
    ...
    static class TestConfigurations {
        ...
        public DataSource dataSource() {
            ...
            dataSource.setUser("socialone");
            dataSource.setPassword("socialone");
            dataSource.setDatabaseName("socialone");
        ...
        private DatabasePopulator databasePopulator() throws IOException {
            ...
            populator.addScript(new ClassPathResource("/com/socialone/data/Providers.sql"));
            return populator;
        }
